...
<div class="card mt-3 mb-3">
  <div class="card-header p-3">
    <i>Total Jatuh Tempo Hari Ini : {{ $countJatuhTempo }} data</i>
  </div>
  <div class="card-datatable text-nowrap">
    <table class="dt-scrollableTable table table-bordered small" id="tableDataTempo">
      <thead>
        <tr>
          <th>No.</th>
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-profile"
                aria-controls="navs-top-profile" aria-selected="false">Pembayaran</button>
            </li>
            <li class="nav-item">
              <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-messages"
                aria-controls="navs-top-messages" aria-selected="false">File
                Pendukung</button>
            </li>
          </ul>
        </div>
...
<script>
  ...
  $(document).ready(function () {
    var table2 = $('#tableDataTempo').DataTable();
